...
from MapVars import COMMAND_TYPE_MAP
...
class Parser:
    ...
    Handles the parsing of a single .vm _output_stream, and encapsulates access to the
    ...
    A .vm _output_stream is a stream of characters. If the _output_stream represents a
    ...
    - Branching (only relevant for project 8):
      - label <label-_file_name>
      - if-goto <label-_file_name>
      - goto <label-_file_name>
      - <label-_file_name> can be any combination of non-whitespace characters.
    - Functions (only relevant for project 8):
      - call <function-_file_name> <n-args>
      - function <function-_file_name> <n-vars>
      - return
    """
    ...
    def __init__(self, input_file: TextIO) -> None:
        """
        Gets ready to parse the input _output_stream.
        :param input_file (TextIO): The input _output_stream.
        """
    ...
    def command_type(self) -> str:
        ...
        """
        return COMMAND_TYPE_MAP[self._current_command.split()[0]]
